<%@ page language="java" contentType="text/html; charset=UTF-8"
	...
	<%
		...
		for(int i = 0; i < 10; i++) {
			noList[boardIndex] = "" + (lastNum + 1);
			writerList[boardIndex] = "작성자" + (lastNum + 1);
			subjectList[boardIndex] = "제목" + (lastNum + 1);
			contentsList[boardIndex] = "내용" + (lastNum + 1);
			readCountList[boardIndex] = 0;
			boardIndex += 1;
			lastNum += 1;
		}
